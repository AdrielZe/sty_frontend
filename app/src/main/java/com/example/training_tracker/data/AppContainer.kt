        ...
        scope.launch {
            ...
            if (currentExercises.isEmpty()) {
                val defaultExercises = listOf(
                    ...
                    Exercise(name = "Agachamento Frontal (Barra)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Agachamento Sumô (Halteres)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Agachamento Smith", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Agachamento Goblet (Kettlebell)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Leg Press 45°", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Leg Press Horizontal", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    ...
                    Exercise(name = "Afundo Reverso", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Afundo Caminhando (Halteres)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Stiff (Halteres)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Stiff (Barra)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Hip Thrust (Barra)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Hip Thrust (Máquina)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Elevação Pélvica (Solo)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Abdução de Quadril (Máquina)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Adução de Quadril (Máquina)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Abdução de Quadril (Polia)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    ...
                    Exercise(name = "Panturrilha no Leg Press", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Panturrilha Livre (Unilateral)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Step Up (Banco)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Agachamento Búlgaro", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Hack Squat (Máquina)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Flexão Nórdica", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Hip Thrust (Barra)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Hip Thrust (Máquina)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Elevação Pélvica (Solo)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Coice de Glúteo (Polia)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Coice de Glúteo (Máquina)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Abdução de Quadril (Máquina)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Agachamento Sumô (Barra)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Agachamento Búlgaro", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Step Up (Banco)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Stiff Unilateral (Halter)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
                    Exercise(name = "Passada Reversa (Smith)", muscleGroup = MuscleGroups.LEGS, isDefault = true),
